...
public class AboutController extends Controller implements Initializable {
	...
	private void loadAboutText() {
		String text = "<h1><a></a>About FilamentDetector</h1>\n"
				+ "<p>The <strong>detection</strong> step is based on the ImageJ1 implementation of Steger, 1998 (<a href=\"http://imagej.net/Ridge_Detection\">http://imagej.net/Ridge_Detection</a>). The <strong>tracking</strong> step is based on the Jaqaman tracking algorithm (Jaqaman, 2008) implemented in <a href=\"https://imagej.net/TrackMate\">TrackMate</a>. Instead of using the euclidean distance as a cost function, <strong>FilamentDetector</strong> usez the bounding boxe of the detected filaments to compute the <a href=\"https://en.wikipedia.org/wiki/Jaccard_index\">Intersection over Union</a>.</p>\n"
				+ "<ul>\n"
